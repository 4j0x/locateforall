execute at @a[scores={endcity=1..},nbt={Dimension:"minecraft:the_end"}] in the_end run setblock 21999999 254 21999999 command_block{Command:"execute as @a at @s run locate endcity"} destroy
